...
<?php  include("top.php"); ?>
 ...
 <?php  include("db_connection.php"); ?>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="pname" style="width:300px; margin-left: 200px; border-radius: 40px;" class="form-control" >
  </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
               ...
               ?>              
                  ...
                  <td><a class="btn btn-danger" href="delete_product.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
...
if(isset($_POST['submit'])){
    ...
    $price=$_POST['price'];
    $desc=$_POST['desc'];
    $res=mysqli_query($conn,"insert into product values(NULL,'$folder','$pname','$price','$desc')");
    if($res){
    ?>
    <script>
