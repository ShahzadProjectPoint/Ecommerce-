            ...
            <table class="table table-bordered">
              ...
              <tbody>
               ...
               ?>              
                  ...
                  <td><a class="btn btn-primary" href="edit_shop.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                  <td><a class="btn btn-danger" href="delete_shop.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
